...
write.csv(table3, "C:/Users/Lisa/Dropbox/Dissertation/Manuscripts/Regional/RegionalMsProject/RegionalMs/Data/20220309_table3_scale_sampSize.csv", quote=T, row.names=F)
write.csv(appendix1, "C:/Users/Lisa/Dropbox/Dissertation/Manuscripts/Regional/RegionalMsProject/RegionalMs/Data/20220309_appendix1_scale_sampSize.csv", quote=T, row.names=F)
write.csv(appendix2, "C:/Users/Lisa/Dropbox/Dissertation/Manuscripts/Regional/RegionalMsProject/RegionalMs/Data/20220309_appendix2_scale_sampSize.csv", quote=T, row.names=F)


write.csv(table3, "C:/Users/Lisa/Dropbox/Dissertation/Manuscripts/Regional/RegionalMsProject/RegionalMs/Tables/table3.csv", quote=T, row.names=F)
write.csv(appendix1, "C:/Users/Lisa/Dropbox/Dissertation/Manuscripts/Regional/RegionalMsProject/RegionalMs/Tables/appendix1.csv", quote=T, row.names=F)
write.csv(appendix2, "C:/Users/Lisa/Dropbox/Dissertation/Manuscripts/Regional/RegionalMsProject/RegionalMs/Tables/appendix2.csv", quote=T, row.names=F)
...
write.csv(xPBGR, "C:/Users/Lisa/Dropbox/Dissertation/Manuscripts/Regional/RegionalMsProject/RegionalMs/Data/xPBGR.csv", quote=T, row.names=F)

write.csv(xVIRA, "C:/Users/Lisa/Dropbox/Dissertation/Manuscripts/Regional/RegionalMsProject/RegionalMs/Data/xVIRA.csv", quote=T, row.names=F)

write.csv(xSORA, "C:/Users/Lisa/Dropbox/Dissertation/Manuscripts/Regional/RegionalMsProject/RegionalMs/Data/xSORA.csv", quote=T, row.names=F)

write.csv(xAMBI, "C:/Users/Lisa/Dropbox/Dissertation/Manuscripts/Regional/RegionalMsProject/RegionalMs/Data/xAMBI.csv", quote=T, row.names=F)
```
